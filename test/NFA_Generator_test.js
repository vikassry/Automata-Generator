...
describe('NFA Generator', function() {
    ...
    describe('Language w | w is string with length divisible', function () {
        var lang = {
            ...
            transition_function:{
              ...
              'q2': {0:['q4'], 1:['q4']},
              'q3': {0:['q5'], 1:['q5']},
              'q4': {0:['q2','q7','q8'], 1:['q2','q8']},
              'q5': {0:['q6'], 1:['q6']},
              'q6': {0:['q3','q9','q10'], 1:['q3','q9','q10']}
            },
            initial_state:"q1" ,
            final_states:['q1','q4','q6','q7']
        };
        var dfa_for_string_length_divisible_by_2_or_3 = NFA_Generator(lang.states, lang.alphabets, lang.transition_function, lang.initial_state, lang.final_states);
        ...
        it('should accept string with length divisible by ', function () {
            assert.ok(dfa_for_string_length_divisible_by_2_or_3('1000'));
        });
    });

    describe('Language w | w is string with length divisible by 2 or 3 | epsilon', function () {
        var lang = {
            states: ["q1","q2","q3","q4","q5","q6"],
            alphabets : ['0','1'],
            transition_function:{
